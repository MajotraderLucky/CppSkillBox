#!/bin/bash
# Batch test runner for M13.6 hwork
# Запускает test.sh для каждой задачи + summary
...
for task in Task1_RemoveX Task2_PricesItems Task3_RingBuffer; do
    echo ""
    echo "============================================================"
    echo "  Running: $task"
    echo "============================================================"
    ...
    if [ -x "$DIR/$task/test.sh" ]; then
        ...
        # Extract counts from output (re-run для grep — эти числа в финальной строке)
